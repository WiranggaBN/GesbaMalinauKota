    ...
    <div class="container">
      <div class="row">
        <div class="col-md-6 mt-5">          
          <img src="rb1.jpg" alt="" class="gambarsatu">
          <a href="ringkasankhotbah"><h3 class="ksatu-judul">Ringkasan Khotbah Minggu, <br> 12 Februari 2023</h3></a>
          <small class="ksatu-span">February 12, 2023</small>
        </div>
        <div class="col-md-3 mt-5">
          <img src="rb1.jpg" alt="" class="gambartiga">
...
<section id="content-dua" >
  <div class="container-fluid">
    <div class="container">
      <div class="row">
        <div class="col-md-4">          
          <img src="rb1.jpg" alt="" class="gambardua">
