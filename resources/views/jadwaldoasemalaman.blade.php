          ...
          <div class="row mt-3">
            <div class="col-md-12">
              ...
              <div class="card-ibadahraya">
                <p class="mt-3"><i class="bi bi-person-circle"></i> Pembicara : <br>&nbsp;&nbsp;&nbsp;&nbsp; {{ $jadwaldoasemalamans->speaker }}</p>
                <p class="mt-3"><i class="bi bi-person-circle"></i> Tema : <br>&nbsp;&nbsp;&nbsp;&nbsp; {{ $jadwaldoasemalamans->theme }}</p>
                <p class="mt-3"><i class="bi bi-calendar-event"></i> {{ $jadwaldoasemalamans->date }}</p>                
                <p class="mt-3"><i class="bi bi-clock"></i> Pukul {{ $jadwaldoasemalamans->time }} WITA</p>
                <p class="mt-3"><i class="bi bi-pin-map"></i> {{ $jadwaldoasemalamans->place }}</p>
                <p class="mt-3"><i class="bi bi-geo-alt"></i> {{ $jadwaldoasemalamans->address }}</p>
              </div>
              @endforeach
            </div>    
        </div>
