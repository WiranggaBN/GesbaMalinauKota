          ...
          <div class="row mt-3">
            <div class="col-md-12">
              <div class="card-ibadahraya">              
                ...
                <p class="mt-3"><i class="bi bi-person-circle"></i> Tema : <br>&nbsp;&nbsp;&nbsp;&nbsp; Mengikuti Teladan Kristus</p>
                <p class="mt-3"><i class="bi bi-calendar-event"></i> Sabtu, 11 Februari 2023</p>                
                <p class="mt-3"><i class="bi bi-clock"></i> Pukul 21:00 WITA</p>
