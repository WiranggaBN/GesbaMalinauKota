  ...
  <div class="container-fluid">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
        <div class="mt-4">          
        <a href="#" class="text-decoration-none"><h2 class="text-dark text-center">PENGAJARAN KABAR PENGANTEN KRISTUS</h2></a>   
