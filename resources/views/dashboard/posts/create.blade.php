...
@section('container')
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Tambah Ringkasan Khotbah</h1>
    </div>
    ...
    <div class="col-lg-8">
        <form method="post" action="/dashboard/posts">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('main_verse') is-invalid @enderror" id="main_verse" name="main_verse" required value="{{ old('main_verse') }}">
                @error('main_verse')
                    <div class="invalid-feedback">  
                        {{ $message }}
                    </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('speaker') is-invalid @enderror" id="speaker" name="speaker" required value="{{ old('speaker') }}">
                @error('speaker')
                    <div class="invalid-feedback">  
                        {{ $message }}
                    </div>
